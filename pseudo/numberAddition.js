...
function numberAddition(str) {
    // 1. Get the definition of a number using a simple regex.
    // 2. Set a variable that will get anything that match the regex, else it will be zero.
    // 3. Declare a sum variable. (initial value of 0)
    // 4. Loop trough the array and add each array item in a parsed form.
    // 5. Return the sum.
}
